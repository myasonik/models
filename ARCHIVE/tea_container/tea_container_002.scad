// tea_container_002 — cylindrical tea canister with 2-start screw lid
// v002: lower thread flank widened to 45° over the full embedded depth
//       so thread undersides print cleanly (v001 measured ~51° overhang)
//
