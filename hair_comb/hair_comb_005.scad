// hair_comb_005.scad — curved plastic side comb, reproduced from photos
...
tooth_w_max  = 4.225; // widest point of the silhouette, at 42% down.
                      // Solved so the narrowest clear gap between two
                      // neighbouring teeth is 0.8. See SPEC section 5.
