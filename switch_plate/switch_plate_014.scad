...
wall_t    = 1.6;     // 4 x 0.4 mm perimeters (at the lip; the outer
                     // surface bevels above it, so the wall thins)
bev_z     = 1.3;     // bevel starts at the top of the retention lip
bev_wall  = 0.8;     // wall bevel inset at the face plane: what the
                     // cavity leaves once the rim clearance is taken
bev_face  = 2.0;     // face chamfer inset, 45 deg over face_t
...
relief_arm_w = 9.0;  // across: wider than the arm and its 8.0 boss
