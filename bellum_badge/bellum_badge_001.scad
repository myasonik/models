...
bold_w    = 0.004 * badge_d;           // stroke thickening for printability

font = "Gabriola";  // ornate serif; try "Palatino Linotype:style=Bold Italic"
...
module text_2d() {
    offset(r = bold_w)
        resize([text_w, 0], auto = true)
            text("Bellum", size = 10, font = font,
