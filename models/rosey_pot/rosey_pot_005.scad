...
// v005: bead pulled back to OD 106 (bead_center_r 51.5 -> 50) so it reaches
// over the decorative pot exactly as far as v003, despite the wider rim.
...
bead_center_r = 50;        // bead OD held at 106; sits 1.5 deep in the wall
